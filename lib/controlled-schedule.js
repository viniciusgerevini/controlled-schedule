...
function createSchedule(_task) {
  ...
  function afterEachSuccess(callback) {
    callbacks['afterEachSuccess'] = callback;
  }
  ...
  function triggerSuccessCallbacks(value) {
    ...
    if(callbacks['afterEachSuccess'])
      callbacks['afterEachSuccess'](value);
  }
